...
state_record_e = np.random.randint(0,ei_net.Ne_y*ei_net.Ne_x,[ei_net.Ne_y*ei_net.Ne_x/100,])
state_record_i = np.random.randint(0,ei_net.Ni_y*ei_net.Ni_x,[ei_net.Ni_y*ei_net.Ni_x/100,])
...
for dump_it in range(options.ndumps):
    ...
    fxn, Pxx_den = signal.welch(LFP,fs, nperseg = 128, scaling = "spectrum")
